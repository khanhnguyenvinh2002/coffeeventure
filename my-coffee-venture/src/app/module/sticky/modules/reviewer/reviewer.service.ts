...
//     public selectResouceByOperation(operationId: string, isSpinner?: boolean): Observable<any[]> {
//         return this.intercept(this.httpClient.get<any[]>(this.url + '/select-resource-by-operation/' + operationId,
...
//                     label: item.name,
//                     data: item,
//                     expandedIcon: 'fas fa-file-chart-line',
//                     collapsedIcon: 'fas fa-file-chart-line',
//                     expanded: false,
...
//         if (node && !isChild) {
//             node.expandedIcon = 'fas fa-file-chart-line';
//             node.collapsedIcon = 'fas fa-file-chart-line';
//         }

//         if (node && isChild) {
//             node.expandedIcon = 'fal fa-file-chart-line';
//             node.collapsedIcon = 'fal fa-file-chart-line';
//         }
//     }
// }
