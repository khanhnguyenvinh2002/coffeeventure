...
export class AuthService extends HttpService {
    ...
    public loginChild(body: any, isSpinner?: boolean): Observable<AccountChild> {
        return this.intercept(this.httpClient.post<AccountChild>(this.url + '/login-child', JSON.stringify(body),
            { observe: 'response', headers: this.getHeaders() }), isSpinner)
            .pipe(map(r => r.body));
    }
