...
import { BaseFormComponent } from 'src/app/module/sticky/component/base-form.component';
...
export class OperationEditComponent extends BaseFormComponent implements OnInit {
