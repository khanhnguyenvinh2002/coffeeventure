(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["view-user-user-module"], {
    ...
    /***/
    function asUO(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var src_app_module_sticky_modules_journal_journal_request_payload__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! src/app/module/sticky/modules/journal/journal-request.payload */
      "e28A");
      /* harmony import */


      var src_app_module_sticky_modules_review_review_request_payload__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var src_app_module_sticky_modules_journal_journal_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! src/app/module/sticky/modules/journal/journal.service */
      "dD+E");
      /* harmony import */


      var src_app_module_sticky_modules_review_review_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! src/app/module/sticky/modules/review/review.service */
      "R1yZ");
      /* harmony import */


      var _module_sticky_common_notification_notification_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../../module/sticky/common/notification/notification.service */
      "w6oe");
      /* harmony import */
      ...
      var _module_sticky_modules_user_user_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./../../../module/sticky/modules/user/user.service */
      "5I3+");
      /* harmony import */
      ...
      var _module_sticky_post_post_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../../../module/sticky/post/post.component */
      "h/6y");
      /* harmony import */


      var _module_sticky_base_base_waiting_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ../../../module/sticky/base/base-waiting.component */
      "vR4d");
      /* harmony import */


      var _module_sticky_review_review_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ../../../module/sticky/review/review.component */
      "IaCn");

      function UserViewComponent_div_18_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserViewComponent_app_waiting_19_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "app-waiting");
        }
      }

      function UserViewComponent_div_22_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div");
      ...
      function UserViewComponent_app_waiting_23_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "app-waiting");
        }
      }
      ...
      var UserViewComponent = /*#__PURE__*/function () {
        function UserViewComponent(cdr, journalService, reviewService, noti, route, userService) {
        ...
        _createClass(UserViewComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.sub = this.route.params.subscribe(function (params) {
              ...
              _this.userService.viewUserById(_this.id).subscribe(function (res) {
                _this.imageUrl = res.avatarPath ? res.avatarPath : 'assets/img/cf_bg1.jpg';
                _this.userName = res.userName;
                _this.request.createdBy = _this.id;
                _this.reviewRequest.createdBy = _this.id;
                _this.request.status = 1;
                _this.reviewRequest.status = 1;
          ...
          key: "initReview",
          value: function initReview() {
            var _this2 = this;

            this.reviewRequest.pageIndex = 0;
            this.reviewRequest.pageSize = 3;
            this.reviewService.getAll(this.reviewRequest).subscribe(function (res) {
              _this2.dataSourceReview.items = res;

              _this2.dataSourceReview.items.forEach(function (element) {
                var temp = [];

                if (element.imageDirectories && element.imageDirectories.length > 0) {
                  element.imageDirectories.forEach(function (e) {
          ...
          key: "initJournal",
          value: function initJournal() {
            var _this3 = this;

            this.request.pageIndex = 0;
            this.request.pageSize = 3;
            this.journalService.getAll(this.request).subscribe(function (res) {
              _this3.dataSource.items = res;

              _this3.dataSource.items.forEach(function (element) {
                var temp = [];
          ...
          key: "onScrollDownReview",
          value: function onScrollDownReview() {
            var _this4 = this;
            ...
            this.reviewService.getAll(this.reviewRequest).subscribe(function (res) {
              if (!res || res == [] || res.length == 0) {
                _this4.stopScrollingReview = true;
                return;
              }
              ...
              _this4.isLoadedReview = true;
              _this4.dataSourceReview.items = _this4.dataSourceReview.items ? _this4.dataSourceReview.items.concat(res) : res;
            });
          }
        }, {
          key: "onScrollDown",
          value: function onScrollDown() {
            ...
            this.journalService.getAll(this.request).subscribe(function (res) {
              ...
              _this5.dataSource.items = _this5.dataSource.items ? _this5.dataSource.items.concat(res) : res;
            });
          }
        }, {
          key: "ngOnDestroy",
      ...
      UserViewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        template: function UserViewComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("scrolled", function UserViewComponent_Template_div_scrolled_17_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("scrolled", function UserViewComponent_Template_div_scrolled_21_listener() {
              return ctx.onScrollDownReview();
            });
    ...
    /***/
    function e28A(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "JournalRequestPayload", function () {
        return JournalRequestPayload;
      });
      /* harmony import */
      ...
      var JournalRequestPayload = /*#__PURE__*/function (_common_http_request_) {
        _inherits(JournalRequestPayload, _common_http_request_);

        var _super = _createSuper(JournalRequestPayload);

        function JournalRequestPayload() {
          _classCallCheck(this, JournalRequestPayload);
    ...
    /***/
    function n60B(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _user_view_user_view_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./user-view/user-view.component */
      "asUO");
      /* harmony import */


      var src_app_module_sticky_control_input_time_input_time_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! src/app/module/sticky/control/input-time/input-time.module */
      "xfXw");
      /* harmony import */


      var _forum_forum_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./forum/forum.component */
      "ptjh");
      /* harmony import */


      var _module_sticky_partials_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./../../module/sticky/partials.module */
      "V0Zc");
      /* harmony import */
      ...
      var primeng_togglebutton__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      ...
      var primeng_messages__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! primeng/messages */
      "dts7");
      /* harmony import */
      ...
      var _shop_saved_shop_saved_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ./shop-saved/shop-saved.component */
      "ydtZ");
      /* harmony import */
      ...
      var primeng_tooltip__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
      /*! primeng/tooltip */
      "xlun");
      /* harmony import */


      var src_app_module_sticky_review_review_module__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
      /*! src/app/module/sticky/review/review.module */
      "Ka1L");
      /* harmony import */
      ...
      UserModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_34__["ɵɵdefineNgModule"]({
        type: UserModule
      });
      UserModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_34__["ɵɵdefineInjector"]({
        factory: function UserModule_Factory(t) {
          return new (t || UserModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _user_routing_module__WEBPACK_IMPORTED_MODULE_5__["UserRoutingModule"], src_app_module_sticky_review_review_module__WEBPACK_IMPORTED_MODULE_33__["ReviewModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], src_app_module_sticky_control_input_time_input_time_module__WEBPACK_IMPORTED_MODULE_1__["InputTimeModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__["NgbModule"], primeng_dialog__WEBPACK_IMPORTED_MODULE_10__["DialogModule"], primeng_inputtextarea__WEBPACK_IMPORTED_MODULE_11__["InputTextareaModule"], primeng_togglebutton__WEBPACK_IMPORTED_MODULE_12__["ToggleButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_13__["MatIconModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_14__["MatMenuModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_15__["MatDatepickerModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_16__["MatNativeDateModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_17__["MatCardModule"], primeng_calendar__WEBPACK_IMPORTED_MODULE_18__["CalendarModule"], ngx_infinite_scroll__WEBPACK_IMPORTED_MODULE_21__["InfiniteScrollModule"], _module_sticky_partials_module__WEBPACK_IMPORTED_MODULE_3__["PartialsModule"], primeng_table__WEBPACK_IMPORTED_MODULE_19__["TableModule"], primeng_messages__WEBPACK_IMPORTED_MODULE_20__["MessagesModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_23__["MatButtonModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_28__["MatSelectModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_25__["MatInputModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_26__["MatPaginatorModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_27__["MatProgressSpinnerModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_29__["MatTooltipModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_24__["MatDialogModule"], // ng-bootstrap modules
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__["NgbDropdownModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__["NgbTooltipModule"], // TranslateModule,
        primeng_confirmdialog__WEBPACK_IMPORTED_MODULE_30__["ConfirmDialogModule"], primeng_inputtext__WEBPACK_IMPORTED_MODULE_31__["InputTextModule"], primeng_tooltip__WEBPACK_IMPORTED_MODULE_32__["TooltipModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_34__["ɵɵsetNgModuleScope"](UserModule, {
          declarations: [_user_component__WEBPACK_IMPORTED_MODULE_6__["UserComponent"], _shop_saved_shop_saved_component__WEBPACK_IMPORTED_MODULE_22__["ShopSavedComponent"], _forum_forum_component__WEBPACK_IMPORTED_MODULE_2__["ForumComponent"], _user_view_user_view_component__WEBPACK_IMPORTED_MODULE_0__["UserViewComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _user_routing_module__WEBPACK_IMPORTED_MODULE_5__["UserRoutingModule"], src_app_module_sticky_review_review_module__WEBPACK_IMPORTED_MODULE_33__["ReviewModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], src_app_module_sticky_control_input_time_input_time_module__WEBPACK_IMPORTED_MODULE_1__["InputTimeModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__["NgbModule"], primeng_dialog__WEBPACK_IMPORTED_MODULE_10__["DialogModule"], primeng_inputtextarea__WEBPACK_IMPORTED_MODULE_11__["InputTextareaModule"], primeng_togglebutton__WEBPACK_IMPORTED_MODULE_12__["ToggleButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_13__["MatIconModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_14__["MatMenuModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_15__["MatDatepickerModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_16__["MatNativeDateModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_17__["MatCardModule"], primeng_calendar__WEBPACK_IMPORTED_MODULE_18__["CalendarModule"], ngx_infinite_scroll__WEBPACK_IMPORTED_MODULE_21__["InfiniteScrollModule"], _module_sticky_partials_module__WEBPACK_IMPORTED_MODULE_3__["PartialsModule"], primeng_table__WEBPACK_IMPORTED_MODULE_19__["TableModule"], primeng_messages__WEBPACK_IMPORTED_MODULE_20__["MessagesModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_23__["MatButtonModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_28__["MatSelectModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_25__["MatInputModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_26__["MatPaginatorModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_27__["MatProgressSpinnerModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_29__["MatTooltipModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_24__["MatDialogModule"], // ng-bootstrap modules
          _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__["NgbDropdownModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__["NgbTooltipModule"], // TranslateModule,
          primeng_confirmdialog__WEBPACK_IMPORTED_MODULE_30__["ConfirmDialogModule"], primeng_inputtext__WEBPACK_IMPORTED_MODULE_31__["InputTextModule"], primeng_tooltip__WEBPACK_IMPORTED_MODULE_32__["TooltipModule"]]
        });
    ...
    /***/
    function ptjh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var src_app_module_sticky_modules_journal_journal_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/module/sticky/modules/journal/journal.service */
      "dD+E");
      /* harmony import */
      ...
      var _module_sticky_common_notification_notification_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../../module/sticky/common/notification/notification.service */
      "w6oe");
      /* harmony import */
      ...
      function ForumComponent_div_14_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div");
      ...
      function ForumComponent_app_waiting_15_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "app-waiting");
        }
      }
      ...
      function ForumComponent_app_waiting_19_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "app-waiting");
        }
      }
      ...
      var ForumComponent = /*#__PURE__*/function () {
        function ForumComponent(cdr, sanitizer, http, journalService, reviewService, noti) {
        ...
        _createClass(ForumComponent, [{
          ...
          value: function initReview() {
            ...
            this.reviewRequest.pageSize = 3;
            this.reviewService.getAll(this.reviewRequest).subscribe(function (res) {
              _this6.dataSourceReview.items = res;

              _this6.dataSourceReview.items.forEach(function (element) {
                var temp = [];
          ...
          value: function initJournal() {
            ...
            this.request.pageSize = 3;
            this.journalService.getAll(this.request).subscribe(function (res) {
              _this7.dataSource.items = res;

              _this7.dataSource.items.forEach(function (element) {
                var temp = [];
          ...
          value: function onScrollDownReview() {
            ...
            this.reviewService.getAll(this.reviewRequest).subscribe(function (res) {
              if (!res || res == [] || res.length == 0) {
                _this8.stopScrollingReview = true;
                return;
              }
              ...
              _this8.isLoadedReview = true;
              _this8.dataSourceReview.items = _this8.dataSourceReview.items ? _this8.dataSourceReview.items.concat(res) : res;
            });
          }
        }, {
          key: "onScrollDown",
          value: function onScrollDown() {
            ...
            this.journalService.getAll(this.request).subscribe(function (res) {
              ...
              _this9.dataSource.items = _this9.dataSource.items ? _this9.dataSource.items.concat(res) : res;
            });
          }
        }]);
      ...
      ForumComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        template: function ForumComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("scrolled", function ForumComponent_Template_div_scrolled_13_listener() {
              return ctx.onScrollDown();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("scrolled", function ForumComponent_Template_div_scrolled_17_listener() {
              return ctx.onScrollDownReview();
            });
    ...
    /***/
    function s0qC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _forum_forum_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./forum/forum.component */
      "ptjh");
      /* harmony import */


      var _shop_saved_shop_saved_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./shop-saved/shop-saved.component */
      "ydtZ");
      /* harmony import */
      ...
      var src_app_module_sticky_modules_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! src/app/module/sticky/modules/auth/auth.guard */
      "vza5");
      /* harmony import */


      var _user_view_user_view_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./user-view/user-view.component */
      "asUO");
      /* harmony import */
      ...
      var routes = [{
        ...
        path: 'saved-shops',
        component: _shop_saved_shop_saved_component__WEBPACK_IMPORTED_MODULE_1__["ShopSavedComponent"],
        canActivate: [src_app_module_sticky_modules_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
      }, {
        path: 'forum',
        component: _forum_forum_component__WEBPACK_IMPORTED_MODULE_0__["ForumComponent"]
      }, {
        path: 'user-view/:id',
        component: _user_view_user_view_component__WEBPACK_IMPORTED_MODULE_5__["UserViewComponent"]
      }];
      ...
      UserRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineNgModule"]({
        type: UserRoutingModule
      });
      UserRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineInjector"]({
    ...
    /***/
    function sH1u(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _module_sticky_modules_journal_journal_request_payload__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./../../module/sticky/modules/journal/journal-request.payload */
      "e28A");
      /* harmony import */


      var src_app_module_sticky_component_base_list_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! src/app/module/sticky/component/base-list.component */
      "LqhL");
      /* harmony import */
      ...
      var src_app_module_sticky_common_confirmation_save_confirmation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! src/app/module/sticky/common/confirmation/save-confirmation */
      "T5lM");
      /* harmony import */


      var src_app_module_sticky_common_confirmation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var src_app_module_sticky_modules_journal_journal_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/module/sticky/modules/journal/journal.service */
      "dD+E");
      /* harmony import */


      var _module_sticky_common_notification_notification_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./../../module/sticky/common/notification/notification.service */
      "w6oe");
      /* harmony import */


      var src_app_module_sticky_modules_auth_auth_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! src/app/module/sticky/modules/auth/auth.service */
      "8VXs");
      /* harmony import */


      var src_app_module_sticky_modules_user_user_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! src/app/module/sticky/modules/user/user.service */
      "5I3+");
      /* harmony import */


      var _module_sticky_upload_upload_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      ...
      var primeng_togglebutton__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! primeng/togglebutton */
      "Y+ZO");
      /* harmony import */


      var _module_sticky_crud_validate_form_validate_form_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      ...
      var _module_sticky_base_base_waiting_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ../../module/sticky/base/base-waiting.component */
      "vR4d");
      /* harmony import */
      ...
      var _module_sticky_post_post_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
      /*! ../../module/sticky/post/post.component */
      "h/6y");
      ...
      function UserComponent_app_waiting_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelement"](0, "app-waiting");
        }
      }

      function UserComponent_img_5_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserComponent_button_8_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function UserComponent_button_8_Template_button_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r10);

            var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"]();

            return ctx_r9.uploadAvatar();
          });
      ...
      function UserComponent_p_messages_31_ng_template_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserComponent_p_messages_31_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserComponent_div_33_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("event", function UserComponent_div_33_Template_app_post_event_1_listener() {
      ...
      function UserComponent_app_waiting_34_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelement"](0, "app-waiting");
        }
      }

      function UserComponent_ng_template_70_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function UserComponent_ng_template_70_Template_button_click_0_listener() {
            ...
            return ctx_r15.onBtnAddJournal();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function UserComponent_ng_template_70_Template_button_click_2_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵrestoreView"](_r16);

            var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵnextContext"]();

            return ctx_r17.onBtnCancelJournal();
          });
      ...
      var UserComponent = /*#__PURE__*/function (_src_app_module_stick) {
        _inherits(UserComponent, _src_app_module_stick);

        var _super2 = _createSuper(UserComponent);

        function UserComponent(cdr, sanitizer, http, journalService, noti, authService, userService) {
          var _this10;
          ...
          _this10.cdr = cdr;
          _this10.sanitizer = sanitizer;
          _this10.http = http;
          _this10.journalService = journalService;
          _this10.noti = noti;
          _this10.authService = authService;
          _this10.userService = userService;
          _this10.input = {};
          _this10.formDataAdd = new FormData();
          _this10.formDataAvatar = new FormData();
          _this10.pipe = new _angular_common__WEBPACK_IMPORTED_MODULE_2__["DatePipe"]('en-US');
          _this10.daysSelected = [];
          _this10.formDisplay = false;
          _this10.isLoaded = false;
          _this10.avatarLoaded = false;
          _this10.journalAdd = {};
          _this10.dataSource = {};
          _this10.images = [];
          _this10.selectedFile = null;
          _this10.request = new _module_sticky_modules_journal_journal_request_payload__WEBPACK_IMPORTED_MODULE_0__["JournalRequestPayload"]();
          _this10.stopScroll = false;
          _this10.allItems = false;
          _this10.pageLoaded = false;
          _this10.imageUrl = 'assets/img/cf_bg1.jpg';

          _this10.isSelected = function (event) {
            var date = event.getFullYear() + "-" + ("00" + (event.getMonth() + 1)).slice(-2) + "-" + ("00" + event.getDate()).slice(-2);
            return _this10.daysSelected.find(function (x) {
              return x == date;
            }) ? "selected" : null;
          };
        ...
        _createClass(UserComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.userService.selectById(this.authService.getUserId()).subscribe(function (element) {
              if (element.avatarPath) {
                _this11.postAvatar = element.avatarPath;
                _this11.imageUrl = _this11.postAvatar;
              }

              _this11.pageLoaded = true;
            });
            this.resetCalendar();
            this.initData();
          }
          ...
          value: function initData() {
            ...
            this.request.pageIndex = 0;
            this.request.pageSize = 3;
            this.journalService.select(this.request).subscribe(function (res) {
              _this12.dataSource.items = res;

              if (_this12.dataSource.items && _this12.dataSource.items.length > 0) {
                _this12.dataSource.items.forEach(function (element) {
                  if (element.length == 0) {
                    _this12.allItems = true;
                    return;
                  }
              ...
              _this12.data = _this12.dataSource.items;
              _this12.stopScroll = false;
              _this12.allItems = false;
            });
          }
        }, {
          key: "upload",
          ...
          key: "loadAvatarImage",
          value: function loadAvatarImage(event) {
            this.imageUrl = event;
            this.cdr.detectChanges();
          }
        }, {
          key: "renewPage",
          value: function renewPage() {
            this.resetCalendar();
            this.initData();
          }
        }, {
          ...
          value: function uploadAvatar() {
            ...
            this.userService.uploadAvatar(this.formDataAvatar).subscribe(function (res) {
              _this14.noti.showSuccess();

              _this14.avatarLoaded = false;

              _this14.userService.selectById(_this14.authService.getUserId()).subscribe(function (element) {
                if (element.avatarPath) {
                  _this14.imageUrl = element.avatarPath;

                  _this14.cdr.detectChanges(); // reader.readAsDataURL(new Blob(e.imagePath]));
          ...
          value: function onScrollDown() {
            ...
            this.journalService.select(this.request).subscribe(function (res) {
              if (res.length == 0) {
                _this15.allItems = true;
                return;
              }

              res.forEach(function (element) {
                var x = new Date(element.createdAt);

                _this15.selectNew(x, _this15.calendar);

                _this15.isSelected(x);
              });
              res.forEach(function (element) {
                var temp = [];
              ...
              _this15.dataSource.items = _this15.dataSource.items = _this15.dataSource.items ? _this15.dataSource.items.concat(res) : res;
              ;
              _this15.data = _this15.dataSource.items;
            });
          }
        }, {
          key: "resetCalendar",
          value: function resetCalendar() {
            ...
            this.journalService.getAllById().subscribe(function (res) {
              res.forEach(function (element) {
                var x = new Date(element.createdAt);

                _this16.selectNew(x, _this16.calendar);

                _this16.isSelected(x);
              });
          ...
          key: "selectNew",
          value: function selectNew(event, calendar) {
            var date = event.getFullYear() + "-" + ("00" + (event.getMonth() + 1)).slice(-2) + "-" + ("00" + event.getDate()).slice(-2);
            var index = this.daysSelected.findIndex(function (x) {
              return x == date;
            });
          ...
          key: "select",
          value: function select(event, calendar) {
            var _this17 = this;

            var date = this.format(event);
            var index = this.daysSelected.findIndex(function (x) {
              return x == date;
            });

            if (index >= 0) {
              this.data = this.dataSource.items.filter(function (x) {
                return _this17.format(new Date(x.createdAt)) == date;
              });
          ...
          value: function handleFileInput(event) {
            ...
            if (event.target.files) {
              ...
              reader.onload = function (event) {
                _this18.imageUrl = event.target.result;
              };
            }
          }
        }, {
          ...
          key: "editJournal",
          value: function editJournal(rowData) {
            var _this19 = this;
            ...
            setTimeout(function () {
              _this19.form.form.markAsPristine();
            }, 0);
            this.formDisplay = true;
          }
        }, {
          key: "onBtnSaveJournal",
          value: function onBtnSaveJournal() {
            var _this20 = this;
            ...
            this.journalService.insert(this.journalAdd).subscribe(function (event) {
              _this20.journalService.uploadJournalImages(event.id, _this20.formDataAdd).subscribe(function (res) {
                _this20.noti.showSuccess();

                _this20.journalContent = "";
                _this20.journalStatus = false;

                _this20.cdr.detectChanges();

                _this20.initData();

                _this20.resetCalendar();
              });
            });
          }
        }, {
          key: "onBtnAddJournal",
          value: function onBtnAddJournal() {
            var _this21 = this;
            ...
            if (this.form) {
              ...
              if (this.form.form.dirty) {
                var save = new src_app_module_sticky_common_confirmation_save_confirmation__WEBPACK_IMPORTED_MODULE_3__["SaveConfirmation"]();

                save.accept = function () {
                  if (_this21.journalStatus == true) {
                    _this21.input.status = 1;
                  }

                  if (_this21.journalStatus == false) {
                    _this21.input.status = 0;
                  }

                  _this21.journalService.insert(_this21.input).subscribe(function (event) {
                    _this21.journalService.uploadJournalImages(event.id, _this21.formDataAdd).subscribe(function (res) {
                      _this21.noti.showSuccess();

                      _this21.journalContent = "";
                      _this21.journalStatus = false;
                      _this21.input = {};
                      _this21.formDisplay = false;
                      setTimeout(function () {
                        _this21.form.form.markAsPristine();
                      }, 0);

                      _this21.initData();

                      _this21.resetCalendar();
          ...
          value: function onBtnCancelJournal() {
            var _this22 = this;

            if (this.form.form.dirty) {
              var cancelConfirmation = new src_app_module_sticky_common_confirmation__WEBPACK_IMPORTED_MODULE_4__["CancelConfirmation"]();

              cancelConfirmation.accept = function () {
                _this22.formDisplay = false;
                _this22.journalContent = "";
                _this22.journalStatus = false;
                _this22.formDataAdd = new FormData();
                _this22.input = {};
                setTimeout(function () {
                  _this22.form.form.markAsPristine();
                }, 0);
        ...
        return UserComponent;
      }(src_app_module_sticky_component_base_list_component__WEBPACK_IMPORTED_MODULE_1__["BaseListComponent"]);
      ...
      UserComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
        type: UserComponent,
        selectors: [["app-user"]],
        ...
        template: function UserComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("onReadImage", function UserComponent_Template_app_upload_onReadImage_7_listener($event) {
              return ctx.loadAvatarImage($event);
            })("onFileLoad", function UserComponent_Template_app_upload_onFileLoad_7_listener($event) {
              return ctx.loadAvatar($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function UserComponent_Template_button_click_18_listener() {
              return ctx.initData();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function UserComponent_Template_div_click_22_listener($event) {
              return $event.stopPropagation();
            });

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](23, "mat-calendar", 14, 15);

            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("selectedChange", function UserComponent_Template_mat_calendar_selectedChange_23_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function UserComponent_Template_button_click_29_listener() {
              return ctx.editJournal();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("scrolled", function UserComponent_Template_div_scrolled_32_listener() {
              return ctx.onScrollDown();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("visibleChange", function UserComponent_Template_p_dialog_visibleChange_36_listener($event) {
              return ctx.formDisplay = $event;
            })("onHide", function UserComponent_Template_p_dialog_onHide_36_listener() {
              return ctx.reset();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("ngModelChange", function UserComponent_Template_input_ngModelChange_47_listener($event) {
              return ctx.input.feeling = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("ngModelChange", function UserComponent_Template_p_toggleButton_ngModelChange_53_listener($event) {
              return ctx.journalStatus = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("ngModelChange", function UserComponent_Template_textarea_ngModelChange_60_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("onFileLoad", function UserComponent_Template_app_upload_onFileLoad_65_listener($event) {
          ...
          if (rf & 2) {
            var _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵreference"](41);
    ...
    /***/
    function ydtZ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ShopSavedComponent", function () {
        return ShopSavedComponent;
      });
      /* harmony import */


      var _module_sticky_modules_user_shop_user_shop_request_payload__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./../../../module/sticky/modules/user-shop/user-shop-request.payload */
      "7mip");
      /* harmony import */
      ...
      var _module_sticky_modules_user_shop_user_shop_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./../../../module/sticky/modules/user-shop/user-shop.service */
      "rF8k");
      /* harmony import */


      var _module_sticky_modules_auth_auth_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./../../../module/sticky/modules/auth/auth.service */
      "8VXs");
      /* harmony import */
      ...
      var _module_sticky_common_notification_notification_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./../../../module/sticky/common/notification/notification.service */
      "w6oe");
      /* harmony import */
      ...
      function ShopSavedComponent_ng_template_7_th_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ShopSavedComponent_ng_template_7_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ShopSavedComponent_ng_template_8_span_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var _c0 = function _c0(a1) {
        return ["/app/shop/shop-item", a1];
      };

      function ShopSavedComponent_ng_template_8_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function ShopSavedComponent_ng_template_8_Template_button_click_16_listener() {
            ...
            return ctx_r11.onBtnDeleteClick(rowData_r6.id);
          });
        ...
        if (rf & 2) {
          var rowData_r6 = ctx.$implicit;
          var rowIndex_r7 = ctx.rowIndex;

          var _r9 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵreference"](15);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpropertyInterpolate"]("title", "X\xF3a");
      ...
      function ShopSavedComponent_mat_spinner_9_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "mat-spinner");
        }
      }

      function ShopSavedComponent_p_messages_11_ng_template_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ShopSavedComponent_p_messages_11_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var ShopSavedComponent = /*#__PURE__*/function () {
        function ShopSavedComponent(userShopService, authService, cd, router, noti) {
          _classCallCheck(this, ShopSavedComponent);
        ...
        _createClass(ShopSavedComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.initData();
          }
          ...
          value: function initData() {
            ...
            var $selectAndCount = [this.userShopService.select(this.userShopRequest), this.userShopService.count(this.userShopRequest)];
            var sub = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["forkJoin"])($selectAndCount).subscribe(function (response) {
              _this23.userName = _this23.authService.getUser();
              _this23.dataSource.items = response[0];
              _this23.dataSource.paginatorTotal = response[1];

              if (_this23.cd && !_this23.cd['destroyed']) {
                _this23.cd.detectChanges();
              }
            });
          ...
          key: "viewShop",
          value: function viewShop(id) {
            this.router.navigate(["apps/shop/shop-item/".concat(id)]);
          }
        }, {
          ...
          value: function onBtnDeleteClick(id) {
            ...
            this.userShopService.deleteShopFromUser(this.userShopRequest).subscribe(function (res) {
              _this24.noti.showSuccess();

              _this24.userShopRequest = new _module_sticky_modules_user_shop_user_shop_request_payload__WEBPACK_IMPORTED_MODULE_0__["UserShopRequestPayload"]();
      ...
      ShopSavedComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        template: function ShopSavedComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("page", function ShopSavedComponent_Template_mat_paginator_page_4_listener($event) {
...
//# sourceMappingURL=view-user-user-module-es5.js.map